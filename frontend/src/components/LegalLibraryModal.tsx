  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 bg-black/80 backdrop-blur-md animate-in fade-in duration-200">
      <div className="relative w-full max-w-6xl max-h-[92vh] flex flex-col bg-[#0c121e] border border-cyan-500/30 rounded-2xl shadow-[0_0_50px_rgba(6,182,212,0.15)] overflow-hidden">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h2 className="text-xl font-bold text-white tracking-wide">
                  Quản Trị Thư Viện Điều Luật & Văn Bản Pháp Quy
                </h2>
              ...
              <p className="text-xs text-slate-400 mt-0.5">
                Cơ sở tri thức điều luật động áp dụng trực tiếp cho thẩm định hợp đồng & phát hiện rủi ro
              </p>
            </div>
          </div>
          <button 
        ...
        {/* KPI Stats Bar */}
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 px-6 py-3.5 bg-slate-900/50 border-b border-slate-800/80">
          <div className="flex items-center gap-3 p-3 rounded-xl bg-slate-800/40 border border-slate-700/50">
            <div className="p-2 rounded-lg bg-cyan-500/10 text-cyan-400">
              <BookOpen className="w-5 h-5" />
            </div>
            <div>
              <div className="text-xs text-slate-400 font-medium">Tổng số điều luật</div>
              <div className="text-xl font-bold text-white">{stats?.total_rules ?? rules.length}</div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 p-3 rounded-xl bg-slate-800/40 border border-slate-700/50">
            ...
            <div>
              <div className="text-xs text-slate-400 font-medium">Lĩnh vực pháp lý</div>
              <div className="text-xl font-bold text-teal-300">{stats?.total_categories ?? 6}</div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 p-3 rounded-xl bg-slate-800/40 border border-slate-700/50">
            ...
            <div>
              <div className="text-xs text-slate-400 font-medium">Văn bản toàn văn đã nạp</div>
              <div className="text-xl font-bold text-amber-300">{stats?.total_statutes ?? 5}</div>
            </div>
          </div>
        ...
        <div className="flex-1 overflow-y-auto px-6 pb-6 space-y-3">
          {isLoading ? (
            ...
            <div className="py-16 text-center text-slate-400 border border-dashed border-slate-800 rounded-2xl">
              ...
              <p className="text-xs text-slate-500 mt-1">Hãy thử tìm kiếm với từ khóa khác hoặc nhấn "Thêm Điều Luật" để tạo mới.</p>
            </div>
          ) : (
